  ...
  slides: [
    {
      ...
      interaction: {
        ...
        revealItems: [
          ...
          { title: 'Cronología', text: '740 – 700 a.C.', icon: 'Calendar', image: 'https://cdn.myportfolio.com/d435fa58-d32c-4141-8a15-0f2bfccdea41/9d567a93-67ef-4f81-902a-e24d394793c0_rw_1920.jpg?h=6c594a8ef410b023bd29d3dca7f74e4b', longContent: 'Desde la muerte del rey Uzías hasta el reinado de Ezequías, en el epicentro de la expansión asiria.' },
          { title: 'Geografía', text: 'Jerusalén y Judá.', icon: 'MapPin', image: 'https://cdn.myportfolio.com/d435fa58-d32c-4141-8a15-0f2bfccdea41/79c9d0af-07c5-431f-9470-9b5010c08a29_rw_1920.png?h=a18f31bd32158d91bcb896450bf893c0', longContent: 'El profeta de Sión, cuyo mensaje nace en el Templo y se extiende a todas las naciones de la tierra.' },
